    ...
    <div className="container mx-auto my-10 max-w-7xl">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-6 border border-gray-200">
        ...
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-medium bg-[#60AAFF] text-gray-200 p-3 rounded-xl">{wordsRemaining} words remaining</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <textarea
              className="w-full p-3 border border-gray-300 rounded-md mb-2 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent resize-y min-h-[150px]"
              rows={8}
      ...
      <div>
          ...
          <div className="space-y-6 p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="flex space-x-2 bg-gray-100 p-1 rounded-md">
              <button
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${humanizationLevel === "low" ? "bg-[#DBEAFE] text-[#1D4ED8]" : "text-gray-700 hover:bg-gray-200"
                  }`}
              ...
              <button
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${humanizationLevel === "medium" ? "bg-[#DBEAFE] text-[#1D4ED8]" : "text-gray-700 hover:bg-gray-200"
                  }`}
              ...
              <button
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${humanizationLevel === "high" ? "bg-[#DBEAFE] text-[#1D4ED8]" : "text-gray-700 hover:bg-gray-200"
                  }`}
            ...
            <button
              className="w-full bg-blue-600 text-white px-4 py-3 rounded-md hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
