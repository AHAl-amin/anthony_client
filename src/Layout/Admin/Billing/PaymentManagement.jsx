                    ...
                    <tbody>
                        {filteredSubscriptions.map((sub) => (
                            <tr key={sub.id} className="hover:bg-gray-50  ">
                                <td className="py-2 px-4 border-b border-gray-400 pl-10">{sub.user} <br /> <span className="text-gray-500">{sub.email}</span></td>
                                <td className="py-2 px-4 border-b border-gray-400 text-center">{sub.plan}</td>
                                ...
                                <td className="py-2 px-4 border-b border-gray-400 text-center">{sub.amount}</td>
                                <td className="py-2 px-4 border-b border-gray-400 text-center">{sub.nextRenewal}</td>
                                <td className="py-2 px-4 border-b border-gray-400 text-center">{sub.startDate}</td>
                                <td className="py-2 border-b border-gray-400 text-center">
